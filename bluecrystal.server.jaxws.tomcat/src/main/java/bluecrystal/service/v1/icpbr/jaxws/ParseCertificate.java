...
@XmlRootElement(name = "parseCertificate", namespace = "http://icpbr.v1.service.bluecrystal/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "parseCertificate", namespace = "http://icpbr.v1.service.bluecrystal/")

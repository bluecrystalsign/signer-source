...
@XmlRootElement(name = "composeEnvelopeADRB21", namespace = "http://icpbr.v1.service.bluecrystal/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "composeEnvelopeADRB21", namespace = "http://icpbr.v1.service.bluecrystal/", propOrder = {
    "signB64",
    "certb64",
    "origHashb64",
    "signingTime"

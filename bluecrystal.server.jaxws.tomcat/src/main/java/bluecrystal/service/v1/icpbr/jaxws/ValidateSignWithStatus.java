...
@XmlRootElement(name = "validateSignWithStatus", namespace = "http://icpbr.v1.service.bluecrystal/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "validateSignWithStatus", namespace = "http://icpbr.v1.service.bluecrystal/", propOrder = {
    "signCmsb64",
    "origHashb64",
    "signingTime",
    "verifyCrlOcsp"
})
public class ValidateSignWithStatus {

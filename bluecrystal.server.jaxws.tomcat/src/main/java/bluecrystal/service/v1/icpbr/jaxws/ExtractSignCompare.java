...
@XmlRootElement(name = "extractSignCompare", namespace = "http://icpbr.v1.service.bluecrystal/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "extractSignCompare", namespace = "http://icpbr.v1.service.bluecrystal/")

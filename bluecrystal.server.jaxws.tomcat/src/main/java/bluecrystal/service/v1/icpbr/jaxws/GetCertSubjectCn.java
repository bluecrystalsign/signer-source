...
@XmlRootElement(name = "getCertSubjectCn", namespace = "http://icpbr.v1.service.bluecrystal/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCertSubjectCn", namespace = "http://icpbr.v1.service.bluecrystal/")

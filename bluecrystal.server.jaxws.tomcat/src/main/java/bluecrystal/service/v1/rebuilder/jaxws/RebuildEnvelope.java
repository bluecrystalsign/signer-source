...
@XmlRootElement(name = "rebuildEnvelope", namespace = "http://rebuilder.v1.service.bluecrystal/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "rebuildEnvelope", namespace = "http://rebuilder.v1.service.bluecrystal/", propOrder = {
    "format",
    "envelopeb64"
})
